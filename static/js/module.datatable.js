...
define(["jquery", "datatables"], function ($) {
  ...
  DataTableModule.prototype = {
     ...
     * @return {null}      null.
     */
    createTable: function createTable(data, opts) {
      var dom = this._dom;

      if (!$.fn.DataTable.isDataTable(dom)) {
        var tableOpts = Object.assign({}, DEFAULTOPTS, opts.table);
        tableOpts.data = data;
        this.table = $(dom).DataTable(tableOpts); // If celledit options is true.
