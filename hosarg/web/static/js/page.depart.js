...
define([
    ...
    'datepicker',
    'datepicker.zh-CN'
], function($, common, Utils, DatatableModule, FileSaver, NavTab, BackUp, DataCheck) {
    'use strict';
    ...
    let backUp = new BackUp(common.backUpUrl, 60,
        () => {
            let jsonData = {
                type: 'depart_bak',
                month: curMonth
            ...
            jsonData.table = table ? table.table.data().toArray() : [];
            jsonData.table2 = table2 ? table2.table.data().toArray() : [];
            jsonData.table3 = table3 ? table3.table.data().toArray() : [];
            return jsonData;
        },
        (data) => {
    ...
    function showTab2(month) {
        Utils.getJson({
            ...
            data => {
                ...
                let departCols = departNames.map((item) => {
                    return {
                        title: item
                    };
                });
